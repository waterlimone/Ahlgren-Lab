...
qiime dada2 denoise-paired --i-demultiplexed-seqs "$1"/sample_trimmed.qza \
--p-trunc-len-f 0 \
--p-trunc-len-r 0 \
--o-table "$1"/dada2/sample_table.qza \
--o-representative-sequences "$1"/dada2/sample_representative_sequences.qza \
--o-denoising-stats "$1"/dada2/sample_denoising_stats.qza