...
--p-threads "$2" \
--o-clustered-table "$1"/qiimeRecords/OTUs/"$1"_OTU_table.qza \
--o-clustered-sequences "$1"/qiimeRecords/OTUs/"$1"_OTU_sequences.qza

qiime tools export --input-path "$1"/qiimeRecords/OTUs/"$1"_OTU_table.qza --output-path "$1"/qiimeRecords/OTUs/